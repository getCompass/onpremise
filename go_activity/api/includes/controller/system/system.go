...
// StatusInfoStruct структура для ответа в методе system.status
...
// Status собираем информацию о состоянии системы
...
// TraceGoroutine получаем информацию о goroutines микросервиса
...
// TraceMemory получаем информацию о выделенной памяти
...
// CpuProfile собираем информацию о нагрузке процессора за указанное время
...
// ReloadConfig обновляем конфигурацию
...
// ReloadSharding обновляем sharding конфигурацию
...
func CheckSharding(ctx context.Context) {
