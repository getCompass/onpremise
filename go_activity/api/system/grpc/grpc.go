...
import (
	...
	grpcController "go_activity/api/includes/handler/grpc"
...
const (
	...
	// ограничение размера запроса на 10MB (4MB default)
	maxMsgSize = 83886080
)
...
func Listen(host string, port int64) {
	...
	pb.RegisterActivityServer(grpcServer, &grpcController.Server{})
