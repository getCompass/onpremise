...
func GetMigrationCleaningDatabase(ctx context.Context, credentials *sharding.DbCredentials, dbName string) (*MigrationDatabaseStruct, error) {
	...
	return makeMigrationLegacyCleanDatabaseStruct(
...
func makeMigrationLegacyCleanDatabaseStruct(shardDbName string, dbName string, isCompleted int, currentVersion int, previousVersion int,
