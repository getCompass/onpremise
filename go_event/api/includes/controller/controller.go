...
// входной запрос, любая структура запрос должна реализовывать
// интерфейс, чтобы однозначно инициализировать компанию
type CompanyRequestStruct struct {
	CompanyId int64 `json:"company_id"`
}

// возвращает ид компании из запроса
func (r *CompanyRequestStruct) getCompanyId() int64 {
	return r.CompanyId
}
