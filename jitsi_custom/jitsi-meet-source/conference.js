...
export default {
    ...
    onToggleAudioOnly() {
        ...
        const displayedMinimizeUserId = APP.UI.getMinimizedVideoID();

        if (displayedUserId) {
            APP.UI.updateLargeVideo(displayedUserId, true);
        }

        if (displayedMinimizeUserId && isMobileBrowser()) {
            APP.UI.updateMinimizedVideo(displayedMinimizeUserId, true);
        }
    },
