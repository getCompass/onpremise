...
import StatelessAvatarMobile from "./web/StatelessAvatarMobile";
 ...
 */
class AvatarMobile<P extends IProps> extends PureComponent<P, IState> {
    /**
     * Default values for {@code AvatarMobile} component's properties.
     *
     * @static
     */
    static defaultProps = {
     ...
     * @param {boolean} params.dontRetry - If false we will retry to load the AvatarMobile with different CORS mode.
     * @returns {void}
     */
...
export default connect(_mapStateToProps)(AvatarMobile);
