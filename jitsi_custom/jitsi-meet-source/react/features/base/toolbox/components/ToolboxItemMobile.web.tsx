...
import ContextMenuItemMobile from "../../ui/components/web/ContextMenuItemMobile";
 ...
 */
export default class ToolboxItemMobile extends AbstractToolboxItem<IProps> {
    /**
     * Initializes a new {@code ToolboxItemMobile} instance.
     *
     * @inheritdoc
     */
        ...
        if (contextMenu) {
            return (
                <ContextMenuItemMobile
                    ...
                    text = {this.label}
                    textIcon = {buttonKey === 'chat-mobile' ? <ChatCounterMobile /> : undefined} />
            );
        }
        let children = (
            <Fragment>
    ...
    _renderIcon() {
        ...
        const iconComponent = (<Icon
            size = {showLabel ? undefined : customClass === 'hangup-menu-button' ? 32 : customClass === 'mobile-header-button' ? 24 : customClass === 'mobile-overflow-toggle-button' ? 22 : 36}
            src = {icon} />);
