...
import ChatCounterMobile from "./ChatCounterMobile";

/**
 * The type of the React {@code Component} props of {@link ChatButtonMobile}.
 */
 ...
 */
class ChatButtonMobile extends AbstractButton<IProps> {
...
export default translate(connect(mapStateToProps)(ChatButtonMobile));
