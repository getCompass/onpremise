...
export default {
    ...
    displayNameAndFilmstripContainer: {
        marginTop: 10,
        marginLeft: 8,
        marginRight: 10,
        // Отступ + высота миниатюры с участником
        // отрицательный, чтобы опустить бейдж на уровень миниатюр
        marginBottom: -(8 + SMALL_THUMBNAIL_SIZE),
