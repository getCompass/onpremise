...
/**
 * The type of the React {@code Component} props of {@link ConnectionIndicatorMobile}.
 */
 ...
 * @augments {Component}
 */
class ConnectionIndicatorMobile extends AbstractConnectionIndicator<IProps, IState> {
    /**
     * Initializes a new {@code ConnectionIndicatorMobile} instance.
     *
...
export default connect(_mapStateToProps)(translate(withStyles(ConnectionIndicatorMobile, styles)));
