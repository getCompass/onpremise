...
import { getVideoTrackByParticipant, isLocalTrackMuted, isRemoteTrackMuted } from '../../../base/tracks/functions.web';
...
/**
 * The type of the React {@code Component} props of {@link StatusIndicatorsMobile}.
 */
interface IProps {
 ...
 * @augments Component
 */
class StatusIndicatorsMobile extends Component<IProps> {
    /**
    ...
    render() {
        ...
        return (
            <>
                {_showAudioMutedIndicator &&
                    <AudioMutedIndicator tooltipPosition = {tooltipPosition} iconColor = 'rgba(255, 255, 255, 0.7)' />}
                {_showModeratorIndicator &&
                    <ModeratorIndicator tooltipPosition = {tooltipPosition} iconColor = 'rgba(255, 255, 255, 0.7)' />}
                {_showScreenShareIndicator &&
                    <ScreenShareIndicator tooltipPosition = {tooltipPosition} iconColor = 'rgba(255, 255, 255, 0.7)' />}
            </>
        );
    }
}
...
/**
 * Maps (parts of) the Redux state to the associated {@code StatusIndicatorsMobile}'s props.
 *
...
export default connect(_mapStateToProps)(StatusIndicatorsMobile);
