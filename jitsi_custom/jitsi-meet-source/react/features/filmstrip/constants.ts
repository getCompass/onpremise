...
/**
 * The tooltip position for the top indicators on the thumbnail.
 */
export const TOP_INDICATORS_TOOLTIP_POSITION: {
    [x: string]: 'right' | 'left' | 'top' | 'bottom';
} = {
    [THUMBNAIL_TYPE.TILE]: 'bottom',
    [THUMBNAIL_TYPE.VERTICAL]: 'left',
    [THUMBNAIL_TYPE.HORIZONTAL]: 'top'
};
