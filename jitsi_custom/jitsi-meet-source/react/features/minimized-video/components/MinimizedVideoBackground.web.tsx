 ...
 * are wider. The dimensions will determine how {@code MinimizedVideoBackground}
 ...
 * {@link MinimizedVideoBackgroundCanvas}.
 */
interface IProps {
 ...
 * @augments Component
 */
export class MinimizedVideoBackground extends Component<IProps> {
    _canvasEl: HTMLCanvasElement;

    _updateCanvasInterval: number | undefined;

    /**
     * Initializes new {@code MinimizedVideoBackground} instance.
     *
     ...
     */
    render() {
        const classNames = "minimized-video-background invisible";
...
/**
 * Maps (parts of) the Redux state to the associated MinimizedVideoBackground props.
 *
...
export default connect(_mapStateToProps)(MinimizedVideoBackground);
