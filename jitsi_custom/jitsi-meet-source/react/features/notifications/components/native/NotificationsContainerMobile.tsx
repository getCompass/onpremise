 ...
 * @augments {Component}
 */
class NotificationsContainerMobile extends Component<IProps> {
    ...
    /**
     * Initializes a new {@code NotificationsContainerMobile} instance.
     *
     * @inheritdoc
     */
...
/**
 * Maps (parts of) the Redux state to the associated NotificationsContainerMobile's
 * props.
 *
...
export default connect(mapStateToProps)(NotificationsContainerMobile);
