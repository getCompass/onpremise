...
export const START_ELECTRON_RECORDING = 'START_ELECTRON_RECORDING';
...
export const STOP_ELECTRON_RECORDING = 'STOP_ELECTRON_RECORDING';
export const TOGGLE_ELECTRON_RECORDING = 'TOGGLE_ELECTRON_RECORDING';
