...
import { isRecordingRunningElectron, getRecordButtonProps } from '../../functions';

/**
 * The type of the React {@code Component} props of
 * {@link AbstractRecordButtonElectron}.
 */
 ...
 */
export default class AbstractRecordButtonElectron<P extends IProps> extends AbstractButton<P> {
...
export function _mapStateToProps(state: IReduxState) {
    ...
    return {
        _disabled,
        _isRecordingRunning: isRecordingRunningElectron(state),
        _tooltip,
        visible
    };
}
