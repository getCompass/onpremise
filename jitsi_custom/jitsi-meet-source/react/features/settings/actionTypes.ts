...
/**
 * The type of (redux) action which sets the visibility of the moderator settings popup.
 */
export const SET_MODERATOR_SETTINGS_VISIBILITY = 'SET_MODERATOR_SETTINGS_VISIBILITY';
