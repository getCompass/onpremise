...
/**
 * The type of the React {@code Component} props of {@link LanguageTab}.
 */
 ...
 * @augments Component
 */
class LanguageTab extends AbstractDialogTab<IProps, any> {
    /**
     * Initializes a new {@code LanguageTab} instance.
     *
    ...
    constructor(props: IProps) {
        ...
        this._onLanguageItemSelectMobile = this._onLanguageItemSelectMobile.bind(this);
    }
     ...
     * Callback invoked to select a language from select dropdown.
     *
     * @param {Object} language - The language key.
     *
     * @returns {void}
     */
    _onLanguageItemSelectMobile(language: string) {
        ...
        if (isMobile) {
            return (
                <SelectMobile
                    ...
                    onSelect={this._onLanguageItemSelectMobile}
...
export default withStyles(translate(LanguageTab), styles);
