...
/**
 * The type of the (redux) action which sets the compass main toolbar thresholds.
 *
 * {
 ...
 * }
 */
export const SET_COMPASS_MAIN_TOOLBAR_BUTTONS_THRESHOLDS = 'SET_COMPASS_MAIN_TOOLBAR_BUTTONS_THRESHOLDS';
