...
import BaseVideoMuteButtonMobile from '../../base/toolbox/components/BaseVideoMuteButtonMobile';
import { isLocalTrackMuted } from '../../base/tracks/functions';
import { handleToggleVideoMuted } from '../actions.any';
import { isVideoMuteButtonDisabled } from '../functions';

/**
 * The type of the React {@code Component} props of {@link AbstractVideoMuteButtonMobile}.
 */
 ...
 *
 * @augments BaseVideoMuteButtonMobile
 */
export default class AbstractVideoMuteButtonMobile<P extends IProps> extends BaseVideoMuteButtonMobile<P> {
