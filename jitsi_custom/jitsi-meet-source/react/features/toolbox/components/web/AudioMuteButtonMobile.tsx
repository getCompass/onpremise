...
import AbstractAudioMuteButtonMobile, {
    IProps as AbstractAudioMuteButtonMobileProps,
    mapStateToProps as abstractMapStateToProps
} from '../AbstractAudioMuteButtonMobile';
...
/**
 * The type of the React {@code Component} props of {@link AudioMuteButtonMobile}.
 */
interface IProps extends AbstractAudioMuteButtonMobileProps {
 ...
 *
 * @augments AbstractAudioMuteButtonMobile
 */
class AudioMuteButtonMobile extends AbstractAudioMuteButtonMobile<IProps> {

    /**
     * Initializes a new {@code AudioMuteButtonMobile} instance.
     *
    ...
    componentWillUnmount() {
        ...
        this.props.dispatch(unregisterShortcut('Ь'));
    }
 ...
 * {@code AudioMuteButtonMobile} component.
 *
...
export default withStyles(translate(connect(_mapStateToProps)(AudioMuteButtonMobile)), styles);
