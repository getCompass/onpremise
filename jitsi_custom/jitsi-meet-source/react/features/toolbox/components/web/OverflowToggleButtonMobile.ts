...
/**
 * The type of the React {@code Component} props of {@link OverflowToggleButtonMobile}.
 */
 ...
 */
class OverflowToggleButtonMobile extends AbstractButton<IProps> {
...
export default connect()(translate(OverflowToggleButtonMobile));
