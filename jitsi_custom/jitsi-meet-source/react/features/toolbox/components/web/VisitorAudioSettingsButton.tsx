 ...
 */
class VisitorAudioSettingsButton extends Component<IProps, IState> {
    /**
     * Initializes a new {@code VisitorAudioSettingsButton} instance.
     *
     * @inheritdoc
     */
    ...
    render() {
        ...
        return visible ? (
            <div
                ...
                <AudioSettingsPopup isVisitorButton = {true}>
