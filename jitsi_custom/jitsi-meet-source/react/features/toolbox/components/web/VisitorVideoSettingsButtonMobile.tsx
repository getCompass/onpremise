...
import VideoMuteButtonMobile from "./VideoMuteButtonMobile";
 ...
 */
class VisitorVideoSettingsButtonMobile extends Component<IProps, IState> {
    /**
     * Initializes a new {@code VisitorVideoSettingsButtonMobile} instance.
     *
     * @inheritdoc
     */
...
export default translate(connect(
    mapStateToProps,
    mapDispatchToProps
)(VisitorVideoSettingsButtonMobile));
