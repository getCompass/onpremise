...
/**
 * Component that renders the tooltip dialog for visitors.
 *
 * @returns {JSX.Element}
 */
export default function VisitorsTooltipDialog() {
            ...
            <div className = {cx('visitor-join-meeting-dialog', classes.container)}>
                ...
                <div className = {cx(classes.textContainer, isMobile && 'is-mobile')}>
                    ...
                    <div className = {cx(classes.title, isMobile && 'is-mobile')}>
                        {t("participantsPane.headings.visitorTooltipTitleMobile")}
                    </div>
                    <div className = {classes.desc}>
                        {t("participantsPane.headings.visitorTooltipMobile")}
                    </div>
                </div>
                <Button
