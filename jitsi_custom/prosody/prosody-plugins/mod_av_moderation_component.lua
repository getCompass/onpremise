...
function notify_whitelist_change(jid, moderators, room, mediaType, removed)
    ...
    for _,mediaType in pairs({'audio', 'video', 'desktop', 'screenshare'}) do
...
function on_message(event)
    ...
    if moderation_command then
        ...
        if mediaType then
            if mediaType ~= 'audio' and mediaType ~= 'video' and mediaType ~= 'desktop' and mediaType ~= 'screenshare' then
