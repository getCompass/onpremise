...
export const DynamicTimerPhoneNumber = ({
	...
	const langStringConfirmCodePhoneNumberDialogResendButton = useLangString("confirm_code_phone_number_dialog.resend_button");
	const langStringConfirmCodePhoneNumberDialogResendAfter = useLangString("confirm_code_phone_number_dialog.resend_after");
	...
	return (
		<Text
			...
			color="b4b4b4"
			style={textSize}
		>{langStringConfirmCodePhoneNumberDialogResendAfter}{minutes}:{String(seconds).padStart(2, '0')}</Text>
	);
}