...
import {
	...
	joinLinkState,
	nameInputState,
	prepareJoinLinkErrorState, useToastConfig
} from "../api/_stores.ts";
...
import {
	...
	DialogContainer,
	DialogContent,
	DialogTrigger, generateDialogId
		...
		>
			...
			>
				...
				>
					...
					<br/>
					{langStringPageInviteInstallAppDesktopTitlePt2}</Text>
			</HStack>
			<Menu
							...
							<MenuItemGroup id="macos_builds">
									...
									<HStack w="100%" justifyContent="space-between">
										<HStack gap="8px">
											...
											<Text
												...
												lh="22"
												color="333e49"
											>{langStringPageTokenDesktopBuildsMacosDownload}</Text>
										</HStack>
										<Text px="8px" py="4px" bgColor="103115128.01" rounded="8px" color="677380" fs="15" lh="18">{langStringPageTokenDesktopBuildsIntelVersion}</Text>
									</HStack>
								</MenuItem>
								<MenuItem id="macos_m1m2">
									<HStack w="100%" justifyContent="space-between">
										...
										<Text px="8px" py="4px" bgColor="103115128.01" rounded="8px" color="677380" fs="15" lh="18">{langStringPageTokenDesktopBuildsM1M2Version}</Text>
									</HStack>
								</MenuItem>
							</MenuItemGroup>
							<Box
							...
							<MenuItemGroup id="other_builds">
								<MenuItem id="windows">
									<HStack gap="8px">
										...
										<Text
											...
											lh="22"
											color="333e49"
										>{langStringPageTokenDesktopBuildsWindowsDownload}</Text>
									</HStack>
								</MenuItem>
									...
									<HStack w="100%" justifyContent="space-between">
										<HStack gap="8px">
											...
											<Text
												...
												lh="22"
												color="333e49"
											>{langStringPageTokenDesktopBuildsLinuxDownload}</Text>
										</HStack>
										<Text px="8px" py="4px" bgColor="103115128.01" rounded="8px" color="677380" fs="15" lh="18">{langStringPageTokenDesktopBuildsDebVersion}</Text>
									</HStack>
								</MenuItem>
								<MenuItem id="linux_tar">
									<HStack w="100%" justifyContent="space-between">
										...
										<Text px="8px" py="4px" bgColor="103115128.01" rounded="8px" color="677380" fs="15" lh="18">{langStringPageTokenDesktopBuildsTarVersion}</Text>
									</HStack>
								</MenuItem>
							</MenuItemGroup>
						</MenuContent>
...
const StepOneContent = ({scrollableParentBlockRef, parentButtonRef, joinLinkAcceptIsLoading}: StepOneContentProps) => {
			...
			{apiAuthGenerateToken.isLoading || !apiAuthGenerateToken.data || joinLinkAcceptIsLoading ? (
				...
				>
					<Text
						...
						fs="13"
						lh="20"
					>{apiAuthGenerateToken.data.authentication_token.substring(0, 120)}</Text>
				</Box>
			)}
		</VStack>
	);
