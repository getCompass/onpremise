	...
	return (
		<VStack gap = "16px">
			...
			{apiAuthGenerateToken.isLoading || !apiAuthGenerateToken.data ? (
				<VStack w = "100%" bgColor = "000000.01" rounded = "8px" px = "12px" pt = "12px" pb = "13px" gap = "4px"
						ref = {parentBlockRef}>
				...
				onClick = {(event) => {
					...
					if (joinLink !== null) {
						...
						window.location.replace(
							...
							}&isPostModeration=${joinLink.is_postmoderation === 1}&role=${
								joinLink.role
							}&isPreviousSpaceMember=${joinLink.was_member_before === 1}`
						);
						setStoreMenuOpen(true);
						return;
					}
					...
					if (
						...
						window.location.replace(
							...
							}&inviterUserId=${prepareJoinLinkErrorData.inviter_user_id}&isPostModeration=${
