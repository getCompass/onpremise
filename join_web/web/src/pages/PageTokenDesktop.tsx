import {Box, HStack, VStack, styled, Center} from "../../styled-system/jsx";
...
import {
	...
	DialogContainer,
	DialogTrigger,
	DialogCloseTrigger, generateDialogId
		...
		>
			...
			>
				...
				>
					...
					<br/>
					{langStringPageTokenStep2DescPt2Desktop}</Text>
			</HStack>
			<Menu
...
const StepOneContent = ({scrollableParentBlockRef, parentButtonRef}: StepOneContentProps) => {
	...
	const langStringPageTokenStep1DescPt1 = useLangString("page_token.step_1.desc_pt1");
	const langStringPageTokenStep1DescPt2 = useLangString("page_token.step_1.desc_pt2");
	const langStringPageTokenStep1Button = useLangString("page_token.step_1.button");
	...
	return (
		...
		>
			...
			>
				...
				>
					...
					>
						<styled.span
							fontFamily="lato_bold"
							fontWeight="700"
						>{langStringPageTokenStep1DescPt1}
						</styled.span>
						<br/>
						{langStringPageTokenStep1DescPt2}
					</Text>
				</HStack>
				<Button
					size="px21py6"
				...
				>
					{langStringPageTokenStep1Button}
				</Button>
			</HStack>
