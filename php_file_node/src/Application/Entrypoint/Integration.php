...
class Integration {
	 ...
	 */
	public static function processRequest(string $method_name, string $module, array $post):array {
		...
		$handler = Resolver::instance()->resolveHandlerByRoute("integration", $route);
