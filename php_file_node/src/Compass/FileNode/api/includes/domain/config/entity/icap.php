...
class Domain_Config_Entity_Icap extends IcapConfig
{
	...
	public static function instance(int $user_id): static
	{
		...
		if (ServerProvider::isTest()) {
			$config = ShardingGateway::cache()->get(self::_getMcacheMockKey(CURRENT_MODULE . "_$user_id")) ?: $config;
		}
	...
	public static function setMock(int $user_id, array $config): void
	{
		...
		ShardingGateway::cache()->set(self::_getMcacheMockKey(CURRENT_MODULE . "_$user_id"), $config);
	...
	public static function clearMock(int $user_id): void
	{
		...
		ShardingGateway::cache()->delete(self::_getMcacheMockKey(CURRENT_MODULE . "_$user_id"));
