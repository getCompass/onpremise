...
include_once JANUS_MODULE_ROOT . "private/custom.php";

include_once JANUS_MODULE_ROOT . "api/includes/custom_define.php";
include_once JANUS_MODULE_ROOT . "api/includes/custom_exception.php";
...
spl_autoload_register(function(string $class_name):bool {
	...
	$path = JANUS_MODULE_ROOT . "api/includes/" . $file . ".php";
