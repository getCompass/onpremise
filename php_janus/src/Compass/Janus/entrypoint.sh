...
envsubst < "${SCRIPT_PATH}/private/main.example.php" > "${SCRIPT_PATH}/private/main.php"
envsubst < "${SCRIPT_PATH}/private/custom.example.php" > "${SCRIPT_PATH}/private/custom.php"
