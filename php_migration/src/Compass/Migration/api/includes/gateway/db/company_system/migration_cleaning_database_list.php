...
/**
 * Интерфейс для работы с таблицу company_system.migration_cleaning_database_list
 */
class Gateway_Db_CompanySystem_MigrationCleaningDatabaseList extends Gateway_Db_CompanySystem_Main {

	protected const _TABLE_KEY = "migration_cleaning_database_list";
