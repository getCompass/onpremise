...
// точки входа для api запросов (протокол PUBLIC_PROTOCOL)
...
define("PUBLIC_ENTRYPOINT_ELECTRON_DOWNLOAD_APP", "${PUBLIC_ENTRYPOINT_ELECTRON_DOWNLOAD_APP}");
define("PUBLIC_ENTRYPOINT_ELECTRON_UPDATE_CDN"	, "${PUBLIC_ENTRYPOINT_ELECTRON_UPDATE_CDN}");
...
define("PUBLIC_ENTRYPOINT_YANDEX_CAPTCHA"		, "${PUBLIC_ENTRYPOINT_YANDEX_CAPTCHA}");
...
define("MANTICORE_CLUSTER_NAME"                		, "${MANTICORE_CLUSTER_NAME}");
// @formatter:on