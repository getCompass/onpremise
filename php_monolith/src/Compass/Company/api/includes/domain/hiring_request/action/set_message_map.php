...
/**
 * Класс для действия установки мапы сообщения у заявки найма
 */
class Domain_HiringRequest_Action_SetMessageMap {
	 ...
	 */
	public static function do(int $hiring_request_id, string $message_map):Struct_Db_CompanyData_HiringRequest {
		...
		$hiring_request->extra = Domain_HiringRequest_Entity_Request::setMessageMap($hiring_request->extra, $message_map);
