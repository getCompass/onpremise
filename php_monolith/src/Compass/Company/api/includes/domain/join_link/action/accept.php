...
class Domain_JoinLink_Action_Accept {
	 ...
	 */
	public static function do(int $user_id, Struct_Db_CompanyData_JoinLink $join_link, string $comment, string $locale):array {
		...
		$hiring_request_id = Domain_HiringRequest_Action_Create::do(
			$join_link->creator_user_id, $user_id, $join_link->join_link_uniq, $entry_id, $join_link->entry_option, $comment, $locale);
