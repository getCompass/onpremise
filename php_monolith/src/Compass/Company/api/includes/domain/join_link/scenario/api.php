...
class Domain_JoinLink_Scenario_Api {
	...
	public static function add(int $user_id, int $user_role, int $user_permissions, string $type, int|false $lives_day_count, int|false $lives_hour_count, int|false $can_use_count, bool $is_postmoderation, int|bool $entry_option, int $method_version = 1):Struct_Db_CompanyData_JoinLink {
		...
		return match ($method_version) {
			METHOD_VERSION_1                   => self::_addV1($user_id, $user_role, $user_permissions, $type, $lives_day_count, $can_use_count, $entry_option),
			METHOD_VERSION_2, METHOD_VERSION_3 => self::_addV2andV3(
				$user_id, $user_role, $user_permissions, $type, $lives_day_count, $lives_hour_count, $can_use_count, $entry_option, $method_version
			),
			default                            => self::_addV2andV3(
	 ...
	 * @throws \returnException
	 */
	protected static function _addV2andV3(int $user_id, int $user_role, int $user_permissions, string $type, int|false $lives_day_count, int|false $lives_hour_count, int|false $can_use_count, int $entry_option, int $method_version):Struct_Db_CompanyData_JoinLink {
	...
	public static function edit(int $user_id, int $user_role, int $user_permissions, string $join_link_uniq, int|false $lives_day_count, int|false $lives_hour_count, int|false $can_use_count, bool|null $is_postmoderation, null|int $entry_option, int $method_version = 1):array {
		...
		return match ($method_version) {
			METHOD_VERSION_1                   => self::_editV1($user_id, $user_role, $user_permissions, $join_link_uniq, $lives_day_count, $can_use_count, $entry_option),
			METHOD_VERSION_2, METHOD_VERSION_3 => self::_editV2AndV3(
	 ...
	 * @throws \parseException
	 */
	protected static function _editV2AndV3(int $user_id, int $user_role, int $user_permissions, string $join_link_uniq, int|false $lives_day_count, int|false $lives_hour_count, int|false $can_use_count, int|null $entry_option, int $method_version):array {
