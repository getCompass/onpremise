...
class Domain_SmartApp_Scenario_Api
{
	...
	public static function edit(
		...
		string | false $avatar_file_key,
		string | false $url,
		int | false $is_open_in_new_window,
		int | false $is_notifications_enabled,
		int | false $is_sound_enabled,
		int | false $is_background_work_enabled,
		string | false $size
	): void {
