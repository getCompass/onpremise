...
/**
 * Класс описывающий событие event.invite_link_edited версии 1
 */
class Gateway_Bus_Sender_Event_InviteLinkEdited_V1 extends Gateway_Bus_Sender_Event_Abstract {

	/** @var int название метода */
	protected const _WS_EVENT = "event.invite_link_edited";
