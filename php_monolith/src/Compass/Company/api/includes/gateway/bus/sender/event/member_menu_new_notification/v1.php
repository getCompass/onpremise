...
/**
 * Класс описывающий событие event.member.menu.new_notification версии 1
 */
class Gateway_Bus_Sender_Event_MemberMenuNewNotification_V1 extends Gateway_Bus_Sender_Event_Abstract {

	/** @var int Название метода */
	protected const _WS_EVENT = "event.member.menu.new_notification";
