...
/**
 * Структура события включения бота
 */
#[\JetBrains\PhpStorm\Immutable]
class Struct_Event_Userbot_Enabled extends Struct_Default {
	 ...
	 */
	public static function build(string $userbot_id, int $userbot_user_id, array $user_id_list, array $conversation_map_list):static {
