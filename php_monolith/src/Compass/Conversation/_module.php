...
define("CONVERSATION_MODULE_ROOT", dirname(__FILE__) . "/");
define("CONVERSATION_MODULE_API", CONVERSATION_MODULE_ROOT . "api/");
...
// подгружаем данные
include_once CONVERSATION_MODULE_ROOT . "_module/autoload.php";
include_once CONVERSATION_MODULE_ROOT . "_module/function.php";
include_once CONVERSATION_MODULE_ROOT . "_module/sharding.php";
...
\BaseFrame\Socket\SocketHandler::init(getConfig("SOCKET_URL"), getConfig("SOCKET_MODULE"), SOCKET_KEY_CONVERSATION, CA_CERTIFICATE);
