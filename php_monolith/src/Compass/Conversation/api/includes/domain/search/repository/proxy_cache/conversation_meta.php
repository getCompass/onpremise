...
/**
 * Загружает мета-данных диалогов.
 */
class Domain_Search_Repository_ProxyCache_ConversationMeta {

	public const HIT_TYPE_LABEL = "conversation_meta";

	/**
	 * Выполняет загрузку мета-данных диалогов.
	 */
	...
	protected static function _loadFn(array $filtered, mixed ...$_):array {
		...
		return Gateway_Db_CompanyConversation_ConversationMetaLegacy::getAll($filtered);
	}
