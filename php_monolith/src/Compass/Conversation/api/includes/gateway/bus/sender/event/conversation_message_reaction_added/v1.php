...
/**
 * класс описывающий событие action.conversation_message_reaction_added версии 1
 */
class Gateway_Bus_Sender_Event_ConversationMessageReactionAdded_V1 extends Gateway_Bus_Sender_Event_Abstract {

	/** @var int название метода */
	protected const _WS_EVENT = "action.conversation_message_reaction_added";
