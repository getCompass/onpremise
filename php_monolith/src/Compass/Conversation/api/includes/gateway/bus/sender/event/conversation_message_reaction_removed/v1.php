...
/**
 * класс описывающий событие action.conversation_message_reaction_removed версии 1
 */
class Gateway_Bus_Sender_Event_ConversationMessageReactionRemoved_V1 extends Gateway_Bus_Sender_Event_Abstract {

	/** @var int название метода */
	protected const _WS_EVENT = "action.conversation_message_reaction_removed";
	 ...
	 */
	public static function makeEvent(string $conversation_map, string $message_map, string $reaction_name, int $user_id, int $updated_at_ms, string $client_launch_uuid):Struct_Sender_Event {
