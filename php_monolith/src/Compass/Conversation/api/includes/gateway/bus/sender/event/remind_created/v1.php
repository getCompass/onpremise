...
class Gateway_Bus_Sender_Event_RemindCreated_V1 extends Gateway_Bus_Sender_Event_Abstract {
	 ...
	 */
	public static function makeEvent(int $remind_id, int $remind_at, int $creator_user_id, string $message_map, string $comment, string $parent_type, string $parent_key, int $messages_updated_version):Struct_Sender_Event {
