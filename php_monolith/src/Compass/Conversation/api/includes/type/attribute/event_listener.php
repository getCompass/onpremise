...
class Type_Attribute_EventListener {
	...
	public const INDEX_PREPARATION_GROUP = "index_preparation"; // группа задач для подготовки индексации
	public const INDEX_GROUP             = "index";             // группа задач для индексации
