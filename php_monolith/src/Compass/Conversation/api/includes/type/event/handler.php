...
class Type_Event_Handler {
	...
	protected array $_listener_class_list = [
		Domain_Conversation_Scenario_Event::class,
		Domain_Task_Scenario_Event::class,
		Domain_System_Scenario_Event::class,
		Domain_Member_Scenario_Event::class,
		Domain_Invite_Scenario_Event::class,
		Domain_Userbot_Scenario_Event::class,
		Domain_Company_Scenario_Event::class,
		SystemEvent_Message::class,
		Type_Script_Handler::class,
	];
	...
	public function handle(array $event):void {
		...
		// обработчик для полученного событиян
