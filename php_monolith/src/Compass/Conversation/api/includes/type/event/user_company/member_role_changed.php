...
class Type_Event_UserCompany_MemberRoleChanged {
	 ...
	 */
	public static function create(int $user_id, int $before_role, int $role):Struct_Event_Base {

		$event_data = Struct_Event_UserCompany_MemberRoleChanged::build($user_id, $before_role, $role, time());
