 ...
 */
class Type_Preview_Parser_Mail extends Type_Preview_Parser_Helper implements Type_Preview_Parser_Interface {
	...
	public static function isRelevantUrl(string $url):bool {
		...
		return inHtml($url, Type_Preview_Parser_Mail::DOMAIN) || ServerProvider::isTest() && inHtml($url, mb_strtolower(self::_SITE_NAME));
	}
