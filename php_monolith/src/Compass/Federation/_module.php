...
// подгружаем данные
include_once FEDERATION_MODULE_ROOT . "_module/autoload.php";
include_once FEDERATION_MODULE_ROOT . "_module/function.php";
include_once FEDERATION_MODULE_ROOT . "_module/sharding.php";
...
\BaseFrame\Socket\SocketHandler::init(getConfig("SOCKET_URL"), getConfig("SOCKET_MODULE"), SOCKET_KEY_FEDERATION);

\BaseFrame\Module\ModuleHandler::init(CURRENT_MODULE);

// возвращаем обработчики
return include_once FEDERATION_MODULE_ROOT . "_module/route.php";