...
class Domain_Ldap_Scenario_Event
{
        ...
        public static function checkingAccounts(Struct_Event_Ldap_AccountChecker $event_data): Type_Task_Struct_Response
        {
                ...
                // добавляем в фильтр модификатор для фильтрации пользователей
                ...
                [$count, $entry_list] = $client->searchEntries(Domain_Ldap_Entity_Config::getUserSearchBase(), $filter, Domain_Ldap_Entity_Config::getUserSearchPageSize(), $attribute_list);
