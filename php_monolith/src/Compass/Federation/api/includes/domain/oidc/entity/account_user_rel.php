 ...
 */
class Domain_Oidc_Entity_AccountUserRel {
	...
	public static function create(string $sub_plain, int $user_id):void {
		...
		$sso_account_user_rel = new Struct_Db_SsoData_SsoAccountUserRel(
			sub_hash: Domain_Oidc_Entity_Protocol_Token::getSubHash($sub_plain),
			user_id: $user_id,
			sub_plain: $sub_plain,
			created_at: time(),
		);
		...
		try {
			...
			throw new Domain_Oidc_Exception_UserRelationship_AlreadyExists();
		}
	}
	 ...
	 * @throws Domain_Oidc_Exception_UserRelationship_NotFound
	 * @throws ParseFatalException
	 */
	public static function getByUserID(int $user_id):Struct_Db_SsoData_SsoAccountUserRel {
		...
		try {
			...
			throw new Domain_Oidc_Exception_UserRelationship_NotFound();
		}
	}
