 ...
 */
class Domain_Oidc_Entity_Protocol_Client {
	...
	public static function init():Gateway_Sso_Oidc_Client {
		...
		$client_id     = Domain_Oidc_Entity_Protocol_Config::getClientID();
		$client_secret = Domain_Oidc_Entity_Protocol_Config::getClientSecret();
		$client        = new Gateway_Sso_Oidc_Client($client_id, $client_secret);
		$client->setProviderConfig(Domain_Oidc_Entity_Protocol_Config::getProviderConfig());
