...
class Type_Autoincrement_Pivot {
	...
	protected const _FILE_META_ID = "pivot_file_meta_id";    // ключ для meta_id пивота
	...
	//
	public static function getFileMetaIdKey(int $year, int $month):string {

		return self::_FILE_META_ID . "_{$year}_{$month}";
	}
