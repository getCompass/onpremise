...
include_once JITSI_MODULE_ROOT . "private/custom.php";
include_once JITSI_MODULE_ROOT . "private/main.php";

include_once JITSI_MODULE_ROOT . "api/includes/custom_define.php";
include_once JITSI_MODULE_ROOT . "api/includes/custom_exception.php";
...
spl_autoload_register(function(string $class_name):bool {
	...
	$path = JITSI_MODULE_ROOT . "api/includes/" . $file . ".php";
