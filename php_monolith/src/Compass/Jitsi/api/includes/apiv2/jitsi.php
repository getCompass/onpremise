...
class Apiv2_Jitsi extends \BaseFrame\Controller\Api
{
	...
	public function createConference(): array
	{
		...
		try {
			 ...
			 */
			[$conference_data, $conference_joining_data, $conference_member_data, $conference_creator_data] = Domain_Jitsi_Scenario_Api::createConference($this->user_id, $space_id, boolval($is_private), boolval($is_lobby));
	...
	public function joinConference(): array
	{
		...
		try {
			 ...
			 * @var Struct_Api_Conference_CreatorData $conference_creator_data
			 */
			[$conference_data, $conference_joining_data, $conference_member_data, $conference_creator_data] = Domain_Jitsi_Scenario_Api::joinConference($this->user_id, $space_id, $link);
		} catch (Domain_Jitsi_Exception_UserActiveConference_UserHaveActiveConference $e) {
