...
class Type_Antispam_User extends Type_Antispam_Main {
	...
	public const JITSI_CREATE_CONFERENCE = [
		"key"    => "JITSI_CREATE_CONFERENCE",
		"limit"  => 20,
		"expire" => 10 * 60,
	];

	public const JITSI_FINISH_CONFERENCE = [
		"key"    => "JITSI_FINISH_CONFERENCE",
		"limit"  => 20,
		"expire" => 10 * 60,
	];
	...
	public static function throwIfBlocked(int $user_id, array $block_key):int {
