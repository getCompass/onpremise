...
define("PIVOT_MODULE_ROOT", dirname(__FILE__) . "/");
define("PIVOT_MODULE_API", PIVOT_MODULE_ROOT . "api/");

// подгружаем данные
include_once PIVOT_MODULE_ROOT . "_module/autoload.php";
include_once PIVOT_MODULE_ROOT . "_module/function.php";
include_once PIVOT_MODULE_ROOT . "_module/sharding.php";
...
\BaseFrame\Socket\SocketHandler::init(getConfig("SOCKET_URL"), getConfig("SOCKET_MODULE"), SOCKET_KEY_PIVOT, CA_CERTIFICATE);

\BaseFrame\Module\ModuleHandler::init(CURRENT_MODULE);

// возвращаем обработчики
return include_once PIVOT_MODULE_ROOT . "_module/route.php";