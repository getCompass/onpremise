...
$CONFIG["LOCALE_TEXT"] = [
	"ru-RU" => [
		"sms_confirm"        => [
			...
			"add_phone"      => "{sms_code} — код для добавления номера телефона в Compass",
		...
		"mail_add"           => [
			"title"   => "Код подтверждения – {confirm_code}",
			"content" => "Ваш код:<h3>{confirm_code}</h3>Используйте его, чтобы подтвердить адрес электронной почты. Почту можно будет ввести для авторизации в корпоративном мессенджере Compass On-premise.",
		],
		"mail_change"        => [
			"title"   => "Код подтверждения – {confirm_code}",
