...
/**
 * класс описывает работу с данными сущности "Сделка", которые сохранены в поле bitrix_entity_list
 * в таблице bitrix_user_entity_rel
 */
class Domain_Bitrix_Entity_UserRel_Deal {

	public const ENTITY_TYPE = "deal";
	...
	/**
	 * Инициализируем структуру данных entity_data сделки
	 *
	 * @return array
	 */
	public static function init(int $deal_id):array {

		$entity_data            = self::_SCHEME_LIST_BY_VERSION[self::_SCHEME_CURRENT_VERSION];
		$entity_data["id"]      = $deal_id;
	 ...
	 */
	public static function getDealID(array $entity_item):int {
