...
/**
 * класс для формирования события об удалении пользователя, которое будет отправлено в партнерку
 */
class Domain_Partner_Entity_Event_UserDeleted extends Domain_Partner_Entity_Event_Abstract {

	protected const _PARTNER_EVENT_TYPE = "user_deleted";
