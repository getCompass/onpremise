...
use Tariff\Plan\MemberCount\OptionExtendPolicy;

/**
 * Класс для формирования товаров типа space_prolong_trial.
 */
class Domain_SpaceTariff_Plan_MemberCount_Product_ProlongTrial {

	protected const _ALLOWED_LIMIT_VALUES = \Tariff\Plan\MemberCount\OptionLimit::ALLOWED_VALUE_LIST;

	// набор доступных вариаций
	public const GOODS_ID_LABEL         = "space_prolong_trial";
	...
	public static function makeAlteration(int $member_count, int $duration):\Tariff\Plan\MemberCount\Alteration {
		...
		return \Tariff\Plan\MemberCount\Alteration::make()
			...
			->setExtendPolicy(OptionExtendPolicy::TRIAL, time() + DAY1 * $duration)
			...
			->setAvailability(new \Tariff\Plan\AlterationAvailability(\Tariff\Plan\AlterationAvailability::AVAILABLE_WHILE_TRIAL));
	}
}