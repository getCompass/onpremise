 ...
 *
 * Class Domain_User_Action_Create_RemindBot
 */
class Domain_User_Action_Create_RemindBot extends Domain_User_Action_Create {

	protected const _NPC_TYPE = Type_User_Main::NPC_TYPE_SYSTEM_BOT_REMIND;
