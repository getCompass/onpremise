...
abstract class Domain_User_Entity_Attribution_DetectAlgorithm_Abstract {
	...
	protected const _PARAMETER_IP_ADDRESS          = "ip_address";
	protected const _PARAMETER_PLATFORM            = "platform";
	protected const _PARAMETER_PLATFORM_OS         = "platform_os";
	protected const _PARAMETER_TIMEZONE_UTC_OFFSET = "timezone_utc_offset";
	protected const _PARAMETER_SCREEN_AVAIL_WIDTH  = "screen_avail_width";
	protected const _PARAMETER_SCREEN_AVAIL_HEIGHT = "screen_avail_height";
