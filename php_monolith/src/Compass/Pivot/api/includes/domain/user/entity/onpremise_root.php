...
class Domain_User_Entity_OnpremiseRoot {
	 ...
	 * В данном поле может быть почта/номер телефона/uid/username(при необходимости могут быть добавлены другие другие типы логинов аутентификации от SSO в дальнейшем)
	 *
	 * @throws ReturnFatalException
	 */
