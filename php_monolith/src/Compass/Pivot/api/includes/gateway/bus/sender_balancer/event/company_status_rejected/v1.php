...
class Gateway_Bus_SenderBalancer_Event_CompanyStatusRejected_V1 extends Gateway_Bus_SenderBalancer_Event_Abstract {
	 ...
	 */
	public static function makeEvent(int $company_id, int $inviter_user_id, string $inviter_full_name, string $inviter_avatar_file_key, string $inviter_avatar_color):Struct_SenderBalancer_Event {
