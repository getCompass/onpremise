...
/**
 * класс-интерфейс для базы данных pivot_rating_{10m}
 */
class Gateway_Db_PivotRating_Main {

	protected const _DB_KEY = "pivot_rating";
	...
	protected static function _getDbKey(int $shard_id):string {
		...
		return self::_DB_KEY . "_" . ceil($shard_id / 10000000) . "0m";
	}
}