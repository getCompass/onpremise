...
/**
 * Методы для работы аутентификации через LDAP
 */
class Onpremiseweb_Auth_Ldap extends \BaseFrame\Controller\Api {
	...
	public function begin():array {
		...
		try {
			[$authentication_token, $is_empty_profile, $user_info, $integration_action_list] = Domain_User_Scenario_OnPremiseWeb_Auth_Ldap
		...
		} catch (Domain_User_Exception_AuthStory_Ldap_UnexpectedBehaviour) {
