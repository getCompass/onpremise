...
class Onpremiseweb_Global extends \BaseFrame\Controller\Api {
	...
	public function start():array {
		...
		[$is_authorized, $user_info, $need_fill_profile, $dictionary, $available_auth_method_list, $sso_protocol, $restrictions] = Domain_User_Scenario_OnPremiseWeb::start($this->user_id);
