...
/**
 * класс-структура для таблицы pivot_phone.phone_add_via_sms_story
 */
class Struct_Db_PivotPhone_PhoneAddViaSmsStory {

	/**
	 * Struct_Db_PivotPhone_PhoneAddViaSmsStory constructor.
	 *
	 * @param int    $add_phone_story_id
