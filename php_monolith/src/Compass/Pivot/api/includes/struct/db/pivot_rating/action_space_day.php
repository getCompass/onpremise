...
/**
 * класс-структура для таблицы pivot_rating_{10m}.action_space_day_list_{1}
 */
class Struct_Db_PivotRating_ActionSpaceDay {

	/**
	 * Struct_Db_PivotRating_ActionSpaceDay constructor
	 *
	 * @param int   $space_id
