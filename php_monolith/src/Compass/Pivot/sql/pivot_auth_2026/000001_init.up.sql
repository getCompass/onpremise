...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_1` (
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_1` (
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_1` (
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_1` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_2` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_2` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_2` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_2` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_3` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_3` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_3` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_3` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_4` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_4` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_4` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_4` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_5` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_5` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_5` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_5` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_6` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_6` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_6` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_6` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_7` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_7` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_7` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_7` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_8` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_8` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_8` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_8` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_9` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_9` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_9` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_9` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_10` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_10` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_10` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_10` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_11` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_11` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_11` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_11` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_list_12` (
	`auth_uniq` VARCHAR(36) NOT NULL COMMENT 'уникальный ключ аутентификации',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли аутентификация',
	`type` INT(11) NOT NULL DEFAULT 0 COMMENT 'тип (логин/регистрация)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_phone_list_12` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_list_12` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
	`company_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id компании',
	`is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'активный ли токен',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`2fa_phone_list_12` (
	`2fa_map` VARCHAR(255) NOT NULL COMMENT 'map подтверждения номера телефона',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'удачное ли подтверждение номера',
	`resend_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во переотправленных смс',
	`error_count` INT(11) NOT NULL DEFAULT 0 COMMENT 'кол-во ошибок',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_1` (
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_2` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_3` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_4` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_5` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_6` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_7` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_8` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_9` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_10` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_11` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_mail_list_12` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
	`is_success` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'успешная ли попытка',
	`has_password` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен пароль в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
	`has_code` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'введен проверочный код в процессе авторизации/регистрации через почту (служит для определения пройден ли данный этап)',
...
CREATE TABLE IF NOT EXISTS `pivot_auth_2026`.`auth_sso_list_1` (
	`auth_map` VARCHAR(255) NOT NULL COMMENT 'map аутентификации',
