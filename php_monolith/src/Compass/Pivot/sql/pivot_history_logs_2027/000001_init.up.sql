USE `pivot_history_logs_2027`;

CREATE TABLE IF NOT EXISTS `pivot_history_logs_2027`.`user_auth_history` (
...
CREATE TABLE IF NOT EXISTS `pivot_history_logs_2027`.`user_change_phone_history` (
	`user_id` BIGINT(20) NOT NULL COMMENT 'id пользователя',
...
CREATE TABLE IF NOT EXISTS `pivot_history_logs_2027`.`user_action_history` (
...
CREATE TABLE IF NOT EXISTS `pivot_history_logs_2027`.`session_history` (
...
CREATE TABLE IF NOT EXISTS `pivot_history_logs_2027`.`join_link_validate_history` (
...
CREATE TABLE IF NOT EXISTS `pivot_history_logs_2027`.`join_link_accepted_history` (
	`history_id` INT(11) NOT NULL AUTO_INCREMENT COMMENT 'идентификатор шага истории',
...
CREATE TABLE IF NOT EXISTS `pivot_history_logs_2027`.`company_history` (
...
CREATE TABLE IF NOT EXISTS `pivot_history_logs_2027`.`send_history` (
