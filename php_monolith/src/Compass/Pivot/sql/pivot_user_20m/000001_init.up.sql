...
CREATE TABLE IF NOT EXISTS `user_list_11` (
...
CREATE TABLE IF NOT EXISTS `user_company_list_11` (
	`user_id` BIGINT(20) NOT NULL DEFAULT 0 COMMENT 'id пользователя',
...
CREATE TABLE IF NOT EXISTS `user_invite_list_11` (
...
CREATE TABLE IF NOT EXISTS `announcement_cache_11` (
...
CREATE TABLE IF NOT EXISTS `announcement_cache_12` (
	`session_uniq` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'уникальный идентификатор сессии пользователя',
	`user_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'идентификатор пользователя',
	`platform` VARCHAR(40) NOT NULL DEFAULT '' COMMENT 'платформа пользователя',
	`expire` INT(11) NOT NULL DEFAULT '0' COMMENT 'точка времени, после которой нужно снова показать анонс пользователю',
...
CREATE TABLE IF NOT EXISTS `announcement_cache_13` (
	`session_uniq` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'уникальный идентификатор сессии пользователя',
	`user_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'идентификатор пользователя',
	`platform` VARCHAR(40) NOT NULL DEFAULT '' COMMENT 'платформа пользователя',
	`expire` INT(11) NOT NULL DEFAULT '0' COMMENT 'точка времени, после которой нужно снова показать анонс пользователю',
...
CREATE TABLE IF NOT EXISTS `announcement_cache_14` (
	`session_uniq` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'уникальный идентификатор сессии пользователя',
	`user_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'идентификатор пользователя',
	`platform` VARCHAR(40) NOT NULL DEFAULT '' COMMENT 'платформа пользователя',
	`expire` INT(11) NOT NULL DEFAULT '0' COMMENT 'точка времени, после которой нужно снова показать анонс пользователю',
...
CREATE TABLE IF NOT EXISTS `announcement_cache_15` (
	`session_uniq` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'уникальный идентификатор сессии пользователя',
	`user_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'идентификатор пользователя',
	`platform` VARCHAR(40) NOT NULL DEFAULT '' COMMENT 'платформа пользователя',
	`expire` INT(11) NOT NULL DEFAULT '0' COMMENT 'точка времени, после которой нужно снова показать анонс пользователю',
...
CREATE TABLE IF NOT EXISTS `announcement_cache_16` (
	`session_uniq` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'уникальный идентификатор сессии пользователя',
	`user_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'идентификатор пользователя',
	`platform` VARCHAR(40) NOT NULL DEFAULT '' COMMENT 'платформа пользователя',
	`expire` INT(11) NOT NULL DEFAULT '0' COMMENT 'точка времени, после которой нужно снова показать анонс пользователю',
...
CREATE TABLE IF NOT EXISTS `announcement_cache_17` (
	`session_uniq` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'уникальный идентификатор сессии пользователя',
	`user_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'идентификатор пользователя',
	`platform` VARCHAR(40) NOT NULL DEFAULT '' COMMENT 'платформа пользователя',
	`expire` INT(11) NOT NULL DEFAULT '0' COMMENT 'точка времени, после которой нужно снова показать анонс пользователю',
...
CREATE TABLE IF NOT EXISTS `announcement_cache_18` (
	`session_uniq` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'уникальный идентификатор сессии пользователя',
	`user_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'идентификатор пользователя',
	`platform` VARCHAR(40) NOT NULL DEFAULT '' COMMENT 'платформа пользователя',
	`expire` INT(11) NOT NULL DEFAULT '0' COMMENT 'точка времени, после которой нужно снова показать анонс пользователю',
...
CREATE TABLE IF NOT EXISTS `announcement_cache_19` (
	`session_uniq` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'уникальный идентификатор сессии пользователя',
	`user_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'идентификатор пользователя',
	`platform` VARCHAR(40) NOT NULL DEFAULT '' COMMENT 'платформа пользователя',
	`expire` INT(11) NOT NULL DEFAULT '0' COMMENT 'точка времени, после которой нужно снова показать анонс пользователю',
...
CREATE TABLE IF NOT EXISTS `announcement_cache_20` (
	`session_uniq` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'уникальный идентификатор сессии пользователя',
	`user_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'идентификатор пользователя',
	`platform` VARCHAR(40) NOT NULL DEFAULT '' COMMENT 'платформа пользователя',
	`expire` INT(11) NOT NULL DEFAULT '0' COMMENT 'точка времени, после которой нужно снова показать анонс пользователю',
