...
include_once PREMISE_MODULE_ROOT_PATH . "private/custom.php";

include_once PREMISE_MODULE_ROOT_PATH . "api/includes/custom_define.php";
include_once PREMISE_MODULE_ROOT_PATH . "api/includes/custom_exception.php";
...
spl_autoload_register(function(string $class_name):bool {
	...
	$path = PREMISE_MODULE_ROOT_PATH . "api/includes/" . $file . ".php";
