...
define("SPEAKER_MODULE_ROOT", dirname(__FILE__) . "/");
define("SPEAKER_MODULE_API", SPEAKER_MODULE_ROOT . "api/");
...
// подгружаем данные
include_once SPEAKER_MODULE_ROOT . "_module/autoload.php";
include_once SPEAKER_MODULE_ROOT . "_module/function.php";
include_once SPEAKER_MODULE_ROOT . "_module/sharding.php";
...
\BaseFrame\Socket\SocketHandler::init(getConfig("SOCKET_URL"), getConfig("SOCKET_MODULE"), SOCKET_KEY_SPEAKER);
...
require_once SPEAKER_MODULE_ROOT . "private/config.php";
require_once SPEAKER_MODULE_ROOT . "private/custom.php";

// возвращаем обработчики
return include_once SPEAKER_MODULE_ROOT . "_module/route.php";
