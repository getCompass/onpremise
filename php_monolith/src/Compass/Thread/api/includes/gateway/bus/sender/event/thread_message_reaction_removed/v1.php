...
/**
 * класс описывающий событие action.thread_message_reaction_removed версии 1
 */
class Gateway_Bus_Sender_Event_ThreadMessageReactionRemoved_V1 extends Gateway_Bus_Sender_Event_Abstract {

	/** @var int название метода */
	protected const _WS_EVENT = "action.thread_message_reaction_removed";
