...
/**
 * класс описывающий событие action.thread_message_received версии 1
 */
class Gateway_Bus_Sender_Event_ThreadMessageReceived_V1 extends Gateway_Bus_Sender_Event_Abstract {

	/** @var int название метода */
	protected const _WS_EVENT = "action.thread_message_received";
	 ...
	 */
	public static function makeEvent(array $message, array $thread_meta, array $follower_list, string $location_type, string $conversation_map, int $threads_updated_version):Struct_Sender_Event {
