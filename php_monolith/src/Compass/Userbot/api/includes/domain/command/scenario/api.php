...
abstract class Domain_Command_Scenario_Api {
	...
	public static function update(string $token, array $command_list):string {
		...
		try {
			...
			Gateway_Socket_Company::updateCommandList($userbot->userbot_id, $command_list, $userbot->company_url);
	...
	public static function getList(string $token):string {
		...
		try {
			...
			$command_list = Gateway_Socket_Company::getCommandList($userbot->userbot_id, $userbot->company_url);
