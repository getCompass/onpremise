...
class Gateway_Socket_Conversation {
	 ...
	 * @long
	 */
	public static function sendMessageToUser(int $userbot_user_id, int $user_id, string|false $text, string|false $file_key, string $company_url):string {
		...
		[$status, $response] = self::_call("userbot.sendMessageToUser", $params, $company_url);
	 ...
	 * @long
	 */
	public static function sendMessageToGroup(int $userbot_user_id, string $conversation_key, string|false $text, string|false $file_key, string $company_url):string {
		...
		[$status, $response] = self::_call("userbot.sendMessageToGroup", $params, $company_url);
	...
	public static function _getCompanyEntrypoint(string $company_url):array {
		...
		return [$domino_entrypoint_config[$domino] . $socket_module_config["conversation"]["socket_path"], $company_id];
	}
}
